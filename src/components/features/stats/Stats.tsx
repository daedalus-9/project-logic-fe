      ...
      <div className="relative z-20 mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="flex flex-col items-center justify-center sm:flex-row">
          <Stat
            num={2500}
            suffix="+"
            subheading="Vetted and trusted haulage partners at your disposal"
          />
          <div className="h-[1px] w-12 bg-zinc-600 sm:h-12 sm:w-[1px]" />
          <Stat
            num={10}
            suffix="k"
            subheading="Loads successfully connected annually"
          />
          <div className="h-[1px] w-12 bg-zinc-600 sm:h-12 sm:w-[1px]" />
          <Stat
            num={100}
            suffix="+"
            subheading="Years combined industry experience"
          />
        </div>
      </div>
